...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
	 ...
	 G4LogicalVolume* GetAbsorber_logical(){return logicAbsorber;};//used for computing mass and dose
	 G4LogicalVolume* GetGap_logical(){return logicGap;};//used for computing mass and dose
  ...
  private:
	 ...
	 G4Box*             solidGapMother;    //pointer to the solid Layer 
     G4LogicalVolume*   logicGapMother;    //pointer to the logical Layer
     G4VPhysicalVolume* physiGapMother;    //pointer to the physical Layer

	 G4Box*             solidAbsorberMother;    //pointer to the solid Layer 
     G4LogicalVolume*   logicAbsorberMother;    //pointer to the logical Layer
     G4VPhysicalVolume* physiAbsorberMother;    //pointer to the physical Layer
