...
void PhysListEmStandard_option3::ConstructProcess()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "gamma") {
	  ...
	  //compton->SetModel(new G4KleinNishinaCompton() );
      ...
      eIoni->SetEmModel(new G4MollerBhabhaModel);//(new MyMollerBhabhaModel);
  ...
  pmanager->AddProcess(new G4eBremsstrahlung,     -1, 3, 3);
      ...
      pIoni->SetEmModel(new G4MollerBhabhaModel);//new MyMollerBhabhaModel);
